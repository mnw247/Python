...
class Book(models.Model):
    ...
    uploaded_by= models.ForeignKey(User, related_name="upload")
...
# User.objects.get(id=1).books_liked.add =(Book.objects.get(id=1))
# User.objects.get(id=3).books_liked.add(Book.all())
